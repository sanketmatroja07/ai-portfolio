...
export const projects: Project[] = [
  ...
  },
  {
    ...
    order: 6,
    repoUrl: null,
    liveUrl: "https://expense-hub-delta.vercel.app/personal",
    ...
    screenshots: [
      {
        id: "landing",
        url: "/projects/expense-hub/landing.png",
        caption:
          "Personal dashboard — balances, recent activity, settle-up, and spending trends",
        order: 1,
      },
    ],
    metadata: {
