...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Privacy World",
    shortDescription:
      "Privacy intelligence application with client-side PDF document generation, analytics integration, and animated Framer Motion interface.",
    longDescription:
      "Privacy World is a Next.js 14 application focused on privacy tools and education. Features include client-side PDF generation with jsPDF, Vercel Analytics and Speed Insights integration, and smooth Framer Motion animations throughout the interface.",
    type: "web",
    status: "active",
    featured: false,
    order: 10,
    ...
    tags: ["privacy", "legal", "tools"],
    screenshots: [],
    metadata: {
      entryPoint: "src/app/page.tsx",
      buildCommand: "npm run build",
      runCommand: "npm run dev (port 3001)",
      architecture: "Next.js App Router with PDF generation",
      patterns: ["Client-side PDF generation", "Vercel analytics integration", "Privacy-first design"],
      features: [
